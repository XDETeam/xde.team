...
export const SignInSaga = () => (
	<Layout>
		...
		<section>
			<h2>Предыдущий вариант исследований</h2>
				...
				<li>
					...
					<ul>
						<li>
							...
							<ul>
								<li>Http&lt;SignInRequest&gt; &rarr; Http&lt;SignInRequest&gt;?</li>
								<li>
									Может быть несколько команд для журналирования в разные
									провайдеры, выполнять параллельно.
								</li>
								<li>Может быть полностью асинхронным.</li>
							</ul>
						</li>
						<li>
							Аутентификация. Проверяет на IP, JWT. Расширяет/создаёт context.
							Потенциально генерирует ошибки 401/
							<ul>
