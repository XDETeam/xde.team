...
const Page = () => (
    <Article>
        ...
        <p>
            TODO: Холистическая идея XDE.app. Не узкая специализация, а намеренно широкий
            спектр для исследования эффекта интеграции (меша).
        </p>
        ...
        <h2>Дизайн</h2>
        <p>
            Холистической посылка (включая меш) можем придать новый смысл принципу SRP,
            поскольку атомарность объектов даёт больше связей.
        </p>
