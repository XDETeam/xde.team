...
const Page = () => (
    <Article>
        ...
        <section>
            ...
            <ul>
                <li>Инженер &ndash; волшебник. XDE Academy &mdash; школа магии.</li>
                
                <li>
                    <Labs.Xde.App.Link/> &ndash; волшебная палочка инженера. Приложение, которое
                    делает всё. И его мы будем создавать на протяжении всего курса.
                </li>

                <li>
                    Один человек может быть решением сложнейшей задачи. Даже миллион глупцов не заменят
                    одного мудреца. Поэтому начать создавать лучше с себя.
                </li>

                <li>
                    TODO: Можно начать с описаний знаний для KE на примере SR для их же закрепления.
                </li>

                <li>
                    Self Engineering. Люди создают для людей. В инженерии нет ничего важнее нас самих.
                    XDE Ac заботится о самообразовании.
                </li>

                <li>Language Engineering. Языки заклинаний.</li>

                <li>Knowledge Engineering. Важная часть SE.</li>

                <li>Informatiks. Концепция определения.</li>

                <li>Spaced Repetition. Обьединяет KE и XDE App.</li>
            </ul>
        </section>
